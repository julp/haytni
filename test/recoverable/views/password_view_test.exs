defmodule Haytni.Recoverable.PasswordViewTest do
  ...
  defp do_test(conn, config, params) do
    ...
    content = render_to_string(@stack.User.PasswordView, "new.html", conn: conn, changeset: changeset, config: config, module: @stack)
  ...
  test "renders edit.html", %{conn: conn} do
    ...
    content = render_to_string(@stack.User.PasswordView, "edit.html", conn: conn, changeset: changeset, module: @stack)
  ...
  #test "renders edit.html with bad token", %{conn: conn} do
    ...
    #content = render_to_string(@stack.User.PasswordView, "edit.html", conn: conn, changeset: changeset, module: module)
    #assert content =~ "name=\"password[password]\""
    #assert content =~ "name=\"password[password_confirmation]\""
