defmodule Haytni.Recoverable.FieldsTest do
  use HaytniWeb.ConnCase, async: true

  @fields ~W[reset_password_token reset_password_sent_at]a
  describe "Haytni.RecoverablePlugin.fields/0 (callback)" do
