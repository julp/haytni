defmodule Haytni.LiveViewPlugin do
  ...
  @moduledoc """
  This module "replace" the *_csrf_token* generated by Phoenix, if you can't use it (caching, workers, ...), to recognize the current authenticated user in channels
  ...
  def expired_tokens_query(query, config) do
    ...
    from(
      t in query,
      where: not (t.context == ^token_context(nil) and t.inserted_at > ago(^config.token_validity, "second"))
    )
  end
